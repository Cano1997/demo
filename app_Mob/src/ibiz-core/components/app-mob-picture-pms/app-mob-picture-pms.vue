<template>
    <div class="app-mobile-picture-pms">
        <van-uploader 
            ...
            <app-img-cropper @getCropData="getCropData" :url="files[0].url" />
    </div>
</template>
...
export default class AppMobPicture extends Vue {
  ...
  public getCropData($event:any){
    let targetImage:any = this.dataURLtoFile($event);
    console.log(targetImage);
  }

  public dataURLtoFile(dataurl:any, filename = 'file') {
