<template>
<ion-page :className="{ 'view-container': true, 'default-mode-view': true, 'demobpickupview': true, 'sys-employee-usr2-mob-pickup-view': true }">
    ...
    <ion-content >
            ...
            :viewState="viewState"
            viewName="SysEmployeeUsr2MobPickupView"  
...
export default class SysEmployeeUsr2MobPickupViewBase extends Vue {

    /**
     * 全局 ui 服务
     *
     * @type {GlobalUiService}
     * @memberof SysEmployeeUsr2MobPickupViewBase
     */
	 ...
	 * @memberof SysEmployeeUsr2MobPickupViewBase
	 */
	protected viewtag: string = 'b39f9237d088a6173a2d1889f2eaa562';
    ...
    protected model: any = {
        ...
        srfCaption: 'sysemployee.views.usr2mobpickupview.caption',
        srfSubCaption: '',
        dataInfo: '',
        viewname:'sysemployee.usr2mobpickupview',
        iconcls: '',
        icon: ''
    }
     ...
     *
     * @type {any[]}
     * @memberof SysEmployeeUsr2MobPickupView
     */
...
<style lang='less'>
@import './sys-employee-usr2-mob-pickup-view.less';
</style>