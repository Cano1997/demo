...
export default class SysEmployeeUserTreeMobMPickupViewBase extends Vue {

    /**
     * 全局 ui 服务
     *
     * @type {GlobalUiService}
     * @memberof SysEmployeeUserTreeMobMPickupViewBase
     */
	 ...
	 * @memberof SysEmployeeUserTreeMobMPickupViewBase
	 */
	protected viewtag: string = 'eef4931ab99bfda807489700470bad47';
     ...
     */
    protected model: any = {
        srfTitle: '人员移动端多数据选择视图（人员树）',
        srfCaption: 'sysemployee.views.usertreemobmpickupview.caption',
        srfSubCaption: '',
        dataInfo: '',
        viewname:'sysemployee.usertreemobmpickupview',
        iconcls: '',
        icon: ''
    }
     ...
     *
     * @type {any[]}
     * @memberof SysEmployeeUserTreeMobMPickupView
     */
    ...
    get container(){
        let ele = document.getElementsByClassName('sys-employee-user-tree-mob-mpickup-view');
...
<style lang='less'>
@import './sys-employee-user-tree-mob-mpickup-view.less';
</style>