<template>
<ion-page :className="{ 'view-container': true, 'default-mode-view': true, 'demobeditview': true, 'sys-employee-login-mob-edit-view': true }">
...
export default class SysEmployeeLoginMobEditViewBase extends Vue {
     ...
     */
    protected model: any = {
        srfTitle: '人员移动端编辑视图（账号信息）',
        srfCaption: 'sysemployee.views.loginmobeditview.caption',
        srfSubCaption: '',
        dataInfo: '',
        viewname:'sysemployee.loginmobeditview',
        iconcls: '',
        icon: ''
    }
...
<style lang='less'>
@import './sys-employee-login-mob-edit-view.less';
</style>