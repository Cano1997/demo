...
<template>
<ion-page :className="{ 'view-container': true, 'default-mode-view': true, 'demoboptview': true, 'bug-cmob-option-view': true }">
...
export default class BugCMobOptionViewBase extends Vue {
...
<style lang='less'>
@import './bug-cmob-option-view.less';
</style>