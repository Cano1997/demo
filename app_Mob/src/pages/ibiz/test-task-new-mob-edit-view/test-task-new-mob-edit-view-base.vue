<template>
<ion-page :className="{ 'view-container': true, 'default-mode-view': true, 'demobeditview': true, 'test-task-new-mob-edit-view': true }">
...
export default class TestTaskNewMobEditViewBase extends Vue {
	 ...
	 * @memberof TestTaskNewMobEditViewBase
	 */
	protected viewtag: string = 'e4b3ed76cdeea1217bbbe1b2098da73c';
    ...
    protected model: any = {
        ...
        srfCaption: 'testtask.views.newmobeditview.caption',
        srfSubCaption: '',
        dataInfo: '',
        viewname:'testtask.newmobeditview',
        iconcls: '',
        icon: 'clipboard'
    }
   ...
   /**
    * 工具栏 TestTaskNewMobEditView 模型
    *
    * @type {*}
    * @memberof TestTaskNewMobEditView
    */
...
<style lang='less'>
@import './test-task-new-mob-edit-view.less';
</style>