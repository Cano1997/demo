<template>
<ion-page :className="{ 'view-container': true, 'default-mode-view': true, 'demobeditview': true, 'project-sup-mob-edit-view': true }">
...
export default class ProjectSupMobEditViewBase extends Vue {
     ...
     */
    protected model: any = {
        srfTitle: '项目移动端编辑视图挂起）',
        srfCaption: 'project.views.supmobeditview.caption',
        srfSubCaption: '',
        dataInfo: '',
        viewname:'project.supmobeditview',
        iconcls: '',
        icon: ''
    }
...
<style lang='less'>
@import './project-sup-mob-edit-view.less';
</style>