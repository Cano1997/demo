...
export default class TodoMobMDViewBase extends Vue {
	 ...
	 * @memberof TodoMobMDViewBase
	 */
	protected viewtag: string = '899ab4d4cfc33b089a9c4aa5118acbf3';
     ...
     * @memberof TodoMobMDViewBase
     */
    protected navContext: any = { 'n_account_eq': '%srfloginname%' };
   ...
   /**
    ...
    public openSearchform() {
      let search :any = this.$refs.searchformtodomobmdview;
      if(search){
          search.open();
      }
    }
