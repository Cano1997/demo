...
<template>
<ion-page :className="{ 'view-container': true, 'default-mode-view': true, 'demoboptview': true, 'task-startmob-option-view': true }">
...
export default class TaskSTARTMobOptionViewBase extends Vue {
     ...
     */
    protected model: any = {
        srfTitle: '任务选项操作视图（开始）',
        srfCaption: 'task.views.startmoboptionview.caption',
        srfSubCaption: '',
        dataInfo: '',
        viewname:'task.startmoboptionview',
        iconcls: '',
        icon: 'tasks'
    }
...
<style lang='less'>
@import './task-startmob-option-view.less';
</style>