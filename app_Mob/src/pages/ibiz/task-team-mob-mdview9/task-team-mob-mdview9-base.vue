...
export default class TaskTeamMobMDView9Base extends Vue {
	 ...
	 * @memberof TaskTeamMobMDView9Base
	 */
	protected viewtag: string = 'e7bc340642f7bc0346a1f220d1523954';
     ...
     */
    protected model: any = {
        srfTitle: '任务团队移动端多数据视图',
        srfCaption: 'taskteam.views.mobmdview9.caption',
        srfSubCaption: '',
        dataInfo: '',
        viewname:'taskteam.mobmdview9',
        iconcls: '',
        icon: ''
    }
   ...
   /**
    ...
    public openSearchform() {
      let search :any = this.$refs.searchformtaskteammobmdview9;
      if(search){
          search.open();
      }
    }
...
<style lang='less'>
@import './task-team-mob-mdview9.less';
</style>