<template>
<ion-page :className="{ 'view-container': true, 'default-mode-view': true, 'demobeditview': true, 'build-new-mob-edit-view': true }">
...
export default class BuildNewMobEditViewBase extends Vue {
	 ...
	 * @memberof BuildNewMobEditViewBase
	 */
	protected viewtag: string = '99e39da3cdfea07b8886a4dd13680b02';
    ...
    protected model: any = {
        srfTitle: '版本移动端编辑视图',
        srfCaption: 'build.views.newmobeditview.caption',
        srfSubCaption: '',
        dataInfo: '',
        viewname:'build.newmobeditview',
        iconcls: '',
        icon: 'code-fork'
    }
   ...
   /**
    * 工具栏 BuildNewMobEditView 模型
    *
    * @type {*}
    * @memberof BuildNewMobEditView
    */
...
<style lang='less'>
@import './build-new-mob-edit-view.less';
</style>