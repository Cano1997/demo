...
<template>
<ion-page :className="{ 'view-container': true, 'default-mode-view': true, 'demoboptview': true, 'story-as-mob-option-view': true }">
...
export default class StoryAsMobOptionViewBase extends Vue {
	 ...
	 * @memberof StoryAsMobOptionViewBase
	 */
	protected viewtag: string = '6530030850ee815ed2c26f0be4f53bad';
...
<style lang='less'>
@import './story-as-mob-option-view.less';
</style>