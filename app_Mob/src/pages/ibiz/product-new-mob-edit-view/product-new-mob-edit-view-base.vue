<template>
<ion-page :className="{ 'view-container': true, 'default-mode-view': true, 'demobeditview': true, 'product-new-mob-edit-view': true }">
...
export default class ProductNewMobEditViewBase extends Vue {

    /**
     * 全局 ui 服务
     *
     * @type {GlobalUiService}
     * @memberof ProductNewMobEditViewBase
     */
	 ...
	 * @memberof ProductNewMobEditViewBase
	 */
	protected viewtag: string = 'd9cdd2f760fb5a1e35bcf8ddeab9417c';
     ...
     */
    protected model: any = {
        srfTitle: '产品移动端编辑视图（新建）',
        srfCaption: 'product.views.newmobeditview.caption',
        srfSubCaption: '',
        dataInfo: '',
        viewname:'product.newmobeditview',
        iconcls: '',
        icon: ''
    }
   ...
   /**
    * 工具栏 ProductNewMobEditView 模型
    *
    * @type {*}
    * @memberof ProductNewMobEditView
    */
...
<style lang='less'>
@import './product-new-mob-edit-view.less';
</style>