<template>
<ion-page :className="{ 'view-container': true, 'default-mode-view': true, 'demobpickupview': true, 'project-module-mob-pickup-view': true }">
...
export default class ProjectModuleMobPickupViewBase extends Vue {
     ...
     */
    protected model: any = {
        srfTitle: '任务模块移动端数据选择视图',
        srfCaption: 'projectmodule.views.mobpickupview.caption',
        srfSubCaption: '',
        dataInfo: '',
        viewname:'projectmodule.mobpickupview',
        iconcls: '',
        icon: ''
    }
     ...
     *
     * @type {any[]}
     * @memberof ProjectModuleMobPickupView
     */
...
<style lang='less'>
@import './project-module-mob-pickup-view.less';
</style>