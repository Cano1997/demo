<template>
<ion-page :className="{ 'view-container': true, 'default-mode-view': true, 'demobmdview': true, 'task-ass-more-mob-mdview': true }">
    ...
    <div id="searchformtaskassmoremobmdview"></div>
...
export default class TaskAssMoreMobMDViewBase extends Vue {
    ...
    protected model: any = {
        srfTitle: '任务移动端多数据视图',
        srfCaption: 'task.views.assmoremobmdview.caption',
        srfSubCaption: '',
        dataInfo: '',
        viewname:'task.assmoremobmdview',
        iconcls: '',
        icon: 'tasks'
    }
   ...
   /**
    ...
    public openSearchform() {
      let search :any = this.$refs.searchformtaskassmoremobmdview;
      if(search){
          search.open();
      }
    }
...
<style lang='less'>
@import './task-ass-more-mob-mdview.less';
</style>