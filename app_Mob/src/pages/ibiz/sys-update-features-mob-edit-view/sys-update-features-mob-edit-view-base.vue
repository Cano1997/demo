<template>
<ion-page :className="{ 'view-container': true, 'default-mode-view': true, 'demobeditview': true, 'sys-update-features-mob-edit-view': true }">
...
export default class SysUpdateFeaturesMobEditViewBase extends Vue {
     ...
     */
    protected model: any = {
        srfTitle: '系统更新功能移动端编辑视图',
        srfCaption: 'sysupdatefeatures.views.mobeditview.caption',
        srfSubCaption: '',
        dataInfo: '',
        viewname:'sysupdatefeatures.mobeditview',
        iconcls: '',
        icon: ''
    }
   ...
   /**
    * 工具栏 SysUpdateFeaturesMobEditView 模型
    *
    * @type {*}
    * @memberof SysUpdateFeaturesMobEditView
    */
...
<style lang='less'>
@import './sys-update-features-mob-edit-view.less';
</style>