<template>
<ion-page :className="{ 'view-container': true, 'default-mode-view': true, 'demobeditview': true, 'build-log-mob-edit-view': true }">
...
export default class BuildLogMobEditViewBase extends Vue {
     ...
     */
    protected model: any = {
        srfTitle: '版本移动端编辑视图（更新日志）',
        srfCaption: 'build.views.logmobeditview.caption',
        srfSubCaption: '',
        dataInfo: '',
        viewname:'build.logmobeditview',
        iconcls: '',
        icon: 'code-fork'
    }
...
<style lang='less'>
@import './build-log-mob-edit-view.less';
</style>