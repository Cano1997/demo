...
export default class BugTestMobMDViewBase extends Vue {
   ...
   /**
    * 工具栏 BugTestMobMDView 模型
    *
    * @type {*}
    * @memberof BugTestMobMDView
    */
    public righttoolbarModels: any = {
            deuiaction1: { name: 'deuiaction1', disabled: false, type: 'DEUIACTION', visabled: true,noprivdisplaymode:2,dataaccaction: 'SRFUR__BUG_CREATE_BUT', uiaction: { tag: 'MobCreate', target: 'NONE' } },
    ...
    protected async righttoolbar_deuiaction1_click(params: any = {}, tag?: any, $event?: any): Promise<any> {
        ...
        if (curUIService) {
            curUIService.Bug_MobCreate(datas, contextJO, paramJO, $event, xData, this);
        }
    }
   ...
   /**
    ...
    public openSearchform() {
      let search :any = this.$refs.searchformbugtestmobmdview;
      if(search){
          search.open();
      }
    }
    ...
    public loadQuickGroupModel(){
        let quickGroupCodeList:any = {tag:'MobBugQuickGroup',codelistType:'STATIC'};
...
<style lang='less'>
@import './bug-test-mob-mdview.less';
</style>