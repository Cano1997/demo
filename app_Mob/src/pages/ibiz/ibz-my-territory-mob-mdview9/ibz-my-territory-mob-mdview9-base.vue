<template>
<embed-view :className="{ 'view-container': true, 'default-mode-view': true, 'demobmdview9': true, 'ibz-my-territory-mob-mdview9': true }">
...
export default class IbzMyTerritoryMobMDView9Base extends Vue {
   ...
   /**
    ...
    public openSearchform() {
      let search :any = this.$refs.searchformibzmyterritorymobmdview9;
      if(search){
          search.open();
      }
    }
...
<style lang='less'>
@import './ibz-my-territory-mob-mdview9.less';
</style>