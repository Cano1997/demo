<template>
<ion-page :className="{ 'view-container': true, 'default-mode-view': true, 'demobeditview': true, 'task-edit-mob-edit-view': true }">
...
export default class TaskEditMobEditViewBase extends Vue {
	 ...
	 * @memberof TaskEditMobEditViewBase
	 */
	protected viewtag: string = '31c08ada7e3c3bc55c550b01fd8422c6';
    ...
    protected model: any = {
        ...
        srfCaption: 'task.views.editmobeditview.caption',
        srfSubCaption: '',
        dataInfo: '',
        viewname:'task.editmobeditview',
        iconcls: '',
        icon: 'tasks'
    }
   ...
   /**
    * 工具栏 TaskEditMobEditView 模型
    *
    * @type {*}
    * @memberof TaskEditMobEditView
    */
...
<style lang='less'>
@import './task-edit-mob-edit-view.less';
</style>