...
<ion-page :className="{ 'view-container': true, 'default-mode-view': true, 'demobmdview': true, 'story-ass-mob-mdview': true }">
    ...
    <div id="searchformstoryassmobmdview"></div>
...
export default class StoryAssMobMDViewBase extends Vue {
	 ...
	 * @memberof StoryAssMobMDViewBase
	 */
	protected viewtag: string = 'a4a6fd9906bc1ecaac85b44ffcc466fe';
   ...
   /**
    ...
    public openSearchform() {
      let search :any = this.$refs.searchformstoryassmobmdview;
      if(search){
          search.open();
      }
    }
...
<style lang='less'>
@import './story-ass-mob-mdview.less';
</style>