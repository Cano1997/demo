<template>
<ion-page :className="{ 'view-container': true, 'default-mode-view': true, 'demobeditview': true, 'product-plan-edit-mob-edit-view': true }">
...
export default class ProductPlanEditMobEditViewBase extends Vue {

    /**
     * 全局 ui 服务
     *
     * @type {GlobalUiService}
     * @memberof ProductPlanEditMobEditViewBase
     */
	 ...
	 * @memberof ProductPlanEditMobEditViewBase
	 */
	protected viewtag: string = 'f1a8132f2473391e383ec58c657e4e2f';
    ...
    protected model: any = {
        ...
        srfCaption: 'productplan.views.editmobeditview.caption',
        srfSubCaption: '',
        dataInfo: '',
        viewname:'productplan.editmobeditview',
        iconcls: '',
        icon: ''
    }
   ...
   /**
    * 工具栏 ProductPlanEditMobEditView 模型
    *
    * @type {*}
    * @memberof ProductPlanEditMobEditView
    */
...
<style lang='less'>
@import './product-plan-edit-mob-edit-view.less';
</style>