...
export default class ActionMobMDView9Base extends Vue {
	 ...
	 * @memberof ActionMobMDView9Base
	 */
	protected viewtag: string = '3c4e9f0d609bc0f1cf08431649cc8e67';
   ...
   /**
    ...
    public openSearchform() {
      let search :any = this.$refs.searchformactionmobmdview9;
      if(search){
          search.open();
      }
    }
...
<style lang='less'>
@import './action-mob-mdview9.less';
</style>