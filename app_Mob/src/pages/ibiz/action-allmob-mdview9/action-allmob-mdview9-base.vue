<template>
<embed-view :className="{ 'view-container': true, 'default-mode-view': true, 'demobmdview9': true, 'action-allmob-mdview9': true }">
...
export default class ActionALLMobMDView9Base extends Vue {
     ...
     */
    protected model: any = {
        srfTitle: '系统日志移动端多数据视图（通用）',
        srfCaption: 'action.views.allmobmdview9.caption',
        srfSubCaption: '',
        dataInfo: '',
        viewname:'action.allmobmdview9',
        iconcls: '',
        icon: ''
    }
   ...
   /**
    ...
    public openSearchform() {
      let search :any = this.$refs.searchformactionallmobmdview9;
      if(search){
          search.open();
      }
    }
...
<style lang='less'>
@import './action-allmob-mdview9.less';
</style>