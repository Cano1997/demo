...
<template>
<ion-page :className="{ 'view-container': true, 'default-mode-view': true, 'demoboptview': true, 'story-change-mob-option-view': true }">
...
export default class StoryChangeMobOptionViewBase extends Vue {
...
<style lang='less'>
@import './story-change-mob-option-view.less';
</style>