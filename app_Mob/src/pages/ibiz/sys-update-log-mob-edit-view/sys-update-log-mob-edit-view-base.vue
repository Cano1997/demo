<template>
<ion-page :className="{ 'view-container': true, 'default-mode-view': true, 'demobeditview': true, 'sys-update-log-mob-edit-view': true }">
...
export default class SysUpdateLogMobEditViewBase extends Vue {
     ...
     */
    protected model: any = {
        srfTitle: '系统更新日志移动端编辑视图',
        srfCaption: 'sysupdatelog.views.mobeditview.caption',
        srfSubCaption: '',
        dataInfo: '',
        viewname:'sysupdatelog.mobeditview',
        iconcls: '',
        icon: ''
    }
...
<style lang='less'>
@import './sys-update-log-mob-edit-view.less';
</style>