<template>
<ion-page :className="{ 'view-container': true, 'default-mode-view': true, 'demobeditview': true, 'test-suite-new-mob-edit-view': true }">
...
export default class TestSuiteNewMobEditViewBase extends Vue {

    /**
     * 全局 ui 服务
     *
     * @type {GlobalUiService}
     * @memberof TestSuiteNewMobEditViewBase
     */
	 ...
	 * @memberof TestSuiteNewMobEditViewBase
	 */
	protected viewtag: string = '236b858424b0a6f5b0c05f6d689741a1';
    ...
    protected model: any = {
        ...
        srfCaption: 'testsuite.views.newmobeditview.caption',
        srfSubCaption: '',
        dataInfo: '',
        viewname:'testsuite.newmobeditview',
        iconcls: '',
        icon: 'suitcase'
    }
   ...
   /**
    * 工具栏 TestSuiteNewMobEditView 模型
    *
    * @type {*}
    * @memberof TestSuiteNewMobEditView
    */
...
<style lang='less'>
@import './test-suite-new-mob-edit-view.less';
</style>