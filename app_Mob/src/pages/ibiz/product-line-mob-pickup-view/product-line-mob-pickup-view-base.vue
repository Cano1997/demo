<template>
<ion-page :className="{ 'view-container': true, 'default-mode-view': true, 'demobpickupview': true, 'product-line-mob-pickup-view': true }">
...
export default class ProductLineMobPickupViewBase extends Vue {
     ...
     * 实体UI服务对象
     *
     * @type ProductLineUIService
     * @memberof ProductLineMobPickupViewBase
     */
    public appUIService: ProductLineUIService = new ProductLineUIService(this.$store);
    ...
    protected engineInit(): void {
        this.engine.init({
            ...
            keyPSDEField: 'productline',
            majorPSDEField: 'productlinename',
            isLoadDefault: true,
        });
    }
     ...
     *
     * @type {any[]}
     * @memberof ProductLineMobPickupView
     */
...
<style lang='less'>
@import './product-line-mob-pickup-view.less';
</style>