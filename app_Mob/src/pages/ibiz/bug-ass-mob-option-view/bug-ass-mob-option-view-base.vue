...
<template>
<ion-page :className="{ 'view-container': true, 'default-mode-view': true, 'demoboptview': true, 'bug-ass-mob-option-view': true }">
...
export default class BugAssMobOptionViewBase extends Vue {
     ...
     */
    protected model: any = {
        srfTitle: 'Bug选项操作视图（指派Bug）',
        srfCaption: 'bug.views.assmoboptionview.caption',
        srfSubCaption: '',
        dataInfo: '',
...
<style lang='less'>
@import './bug-ass-mob-option-view.less';
</style>