<template>
<ion-page :className="{ 'view-container': true, 'default-mode-view': true, 'demobeditview': true, 'bug-activation-mob-edit-view': true }">
...
export default class BugActivationMobEditViewBase extends Vue {
   ...
   /**
    * 工具栏 BugActivationMobEditView 模型
    *
    * @type {*}
...
<style lang='less'>
@import './bug-activation-mob-edit-view.less';
</style>