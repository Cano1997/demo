<template>
<ion-page :className="{ 'view-container': true, 'default-mode-view': true, 'demobeditview': true, 'test-task-edit-new-mob-edit-view': true }">
...
export default class TestTaskEditNewMobEditViewBase extends Vue {

    /**
     * 全局 ui 服务
     *
     * @type {GlobalUiService}
     * @memberof TestTaskEditNewMobEditViewBase
     */
	 ...
	 * @memberof TestTaskEditNewMobEditViewBase
	 */
	protected viewtag: string = 'cce5a9e728543928168dc497b6851ecb';
    ...
    protected model: any = {
        ...
        srfCaption: 'testtask.views.editnewmobeditview.caption',
        srfSubCaption: '',
        dataInfo: '',
        viewname:'testtask.editnewmobeditview',
        iconcls: '',
        icon: 'clipboard'
    }
   ...
   /**
    * 工具栏 TestTaskEditNewMobEditView 模型
    *
    * @type {*}
    * @memberof TestTaskEditNewMobEditView
    */
...
<style lang='less'>
@import './test-task-edit-new-mob-edit-view.less';
</style>