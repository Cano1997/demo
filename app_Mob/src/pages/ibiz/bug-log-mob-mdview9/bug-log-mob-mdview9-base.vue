...
export default class BugLogMobMDView9Base extends Vue {
     ...
     */
    protected model: any = {
        srfTitle: 'Bug移动端多数据视图（更新日志）',
        srfCaption: 'bug.views.logmobmdview9.caption',
        srfSubCaption: '',
        dataInfo: '',
        viewname:'bug.logmobmdview9',
        iconcls: '',
        icon: 'bug'
    }
   ...
   /**
    ...
    public openSearchform() {
      let search :any = this.$refs.searchformbuglogmobmdview9;
      if(search){
          search.open();
      }
    }
...
<style lang='less'>
@import './bug-log-mob-mdview9.less';
</style>