...
export default class StoryLogMobMDView9Base extends Vue {
	 ...
	 * @memberof StoryLogMobMDView9Base
	 */
	protected viewtag: string = '55804d2c14c94aaab24b2ad0d4db08d8';
     ...
     */
    protected model: any = {
        srfTitle: '需求移动端多数据视图（更新日志）',
        srfCaption: 'story.views.logmobmdview9.caption',
        srfSubCaption: '',
        dataInfo: '',
        viewname:'story.logmobmdview9',
        iconcls: '',
        icon: 'star-o'
    }
   ...
   /**
    ...
    public openSearchform() {
      let search :any = this.$refs.searchformstorylogmobmdview9;
      if(search){
          search.open();
      }
    }
...
<style lang='less'>
@import './story-log-mob-mdview9.less';
</style>