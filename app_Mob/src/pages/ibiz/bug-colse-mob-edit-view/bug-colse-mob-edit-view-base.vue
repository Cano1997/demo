<template>
<ion-page :className="{ 'view-container': true, 'default-mode-view': true, 'demobeditview': true, 'bug-colse-mob-edit-view': true }">
...
export default class BugColseMobEditViewBase extends Vue {
...
<style lang='less'>
@import './bug-colse-mob-edit-view.less';
</style>