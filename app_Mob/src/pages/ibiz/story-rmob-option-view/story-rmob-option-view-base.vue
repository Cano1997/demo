...
<template>
<ion-page :className="{ 'view-container': true, 'default-mode-view': true, 'demoboptview': true, 'story-rmob-option-view': true }">
...
export default class StoryRMobOptionViewBase extends Vue {
     ...
     */
    protected model: any = {
        srfTitle: '需求选项操作视图（评审）',
        srfCaption: 'story.views.rmoboptionview.caption',
        srfSubCaption: '',
        dataInfo: '',
...
<style lang='less'>
@import './story-rmob-option-view.less';
</style>