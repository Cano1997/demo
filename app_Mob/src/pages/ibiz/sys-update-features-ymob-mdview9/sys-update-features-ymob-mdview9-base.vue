<template>
<embed-view :className="{ 'view-container': true, 'default-mode-view': true, 'demobmdview9': true, 'sys-update-features-ymob-mdview9': true }">
...
export default class SysUpdateFeaturesYMobMDView9Base extends Vue {
     ...
     */
    protected model: any = {
        srfTitle: '系统更新功能移动端多数据视图（优化）',
        srfCaption: 'sysupdatefeatures.views.ymobmdview9.caption',
        srfSubCaption: '',
        dataInfo: '',
        viewname:'sysupdatefeatures.ymobmdview9',
        iconcls: '',
        icon: ''
    }
     ...
     * @returns {Promise<any>}
     * @memberof SysUpdateFeaturesYMobMDView9
     */
   ...
   /**
    ...
    public openSearchform() {
      let search :any = this.$refs.searchformsysupdatefeaturesymobmdview9;
      if(search){
          search.open();
      }
    }
...
<style lang='less'>
@import './sys-update-features-ymob-mdview9.less';
</style>