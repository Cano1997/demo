...
<template>
<ion-page :className="{ 'view-container': true, 'default-mode-view': true, 'demoboptview': true, 'bug-acmob-option-view': true }">
...
export default class BugACMobOptionViewBase extends Vue {
	 ...
	 * @memberof BugACMobOptionViewBase
	 */
	protected viewtag: string = '3cada37cd0f6b5c0492af340b3aa0a65';
     ...
     */
    protected model: any = {
        srfTitle: 'Bug选项操作视图（激活Bug）',
        srfCaption: 'bug.views.acmoboptionview.caption',
        srfSubCaption: '',
        dataInfo: '',
        viewname:'bug.acmoboptionview',
        iconcls: '',
        icon: 'bug'
    }
...
<style lang='less'>
@import './bug-acmob-option-view.less';
</style>