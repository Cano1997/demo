<template>
<ion-page :className="{ 'view-container': true, 'default-mode-view': true, 'demobmdview': true, 'story-favorite-mob-mdview': true }">
    ...
    <div id="searchformstoryfavoritemobmdview"></div>
...
export default class StoryFavoriteMobMDViewBase extends Vue {
	 ...
	 * @memberof StoryFavoriteMobMDViewBase
	 */
	protected viewtag: string = 'c55172fa3818041e87a38262949c0c96';
    ...
    protected model: any = {
        srfTitle: '需求移动端多数据视图',
        srfCaption: 'story.views.favoritemobmdview.caption',
        srfSubCaption: '',
        dataInfo: '',
        viewname:'story.favoritemobmdview',
        iconcls: '',
        icon: 'star-o'
    }
   ...
   /**
    ...
    public openSearchform() {
      let search :any = this.$refs.searchformstoryfavoritemobmdview;
      if(search){
          search.open();
      }
    }
...
<style lang='less'>
@import './story-favorite-mob-mdview.less';
</style>