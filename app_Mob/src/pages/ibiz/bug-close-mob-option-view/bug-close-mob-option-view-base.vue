...
export default class BugCloseMobOptionViewBase extends Vue {
     ...
     */
    protected model: any = {
        srfTitle: 'Bug选项操作视图（关闭Bug）',
        srfCaption: 'bug.views.closemoboptionview.caption',
        srfSubCaption: '',
        dataInfo: '',
        viewname:'bug.closemoboptionview',
        iconcls: '',
        icon: 'bug'
    }
...
<style lang='less'>
@import './bug-close-mob-option-view.less';
</style>