<template>
<ion-page :className="{ 'view-container': true, 'default-mode-view': true, 'demobeditview': true, 'bug-assign-to-mob-edit-view': true }">
...
export default class BugAssignToMobEditViewBase extends Vue {

    /**
     * 全局 ui 服务
     *
     * @type {GlobalUiService}
     * @memberof BugAssignToMobEditViewBase
     */
	 ...
	 * @memberof BugAssignToMobEditViewBase
	 */
	protected viewtag: string = '9a78bd0bf4ddaee8cfa25375dbd766c6';
    ...
    protected model: any = {
        srfTitle: 'Bug移动端编辑视图',
        srfCaption: 'bug.views.assigntomobeditview.caption',
        srfSubCaption: '',
        dataInfo: '',
        viewname:'bug.assigntomobeditview',
        iconcls: '',
        icon: 'bug'
    }
...
<style lang='less'>
@import './bug-assign-to-mob-edit-view.less';
</style>