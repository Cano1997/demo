<template>
<ion-page :className="{ 'view-container': true, 'default-mode-view': true, 'demobeditview': true, 'project-close-mob-edit-view': true }">
...
export default class ProjectCloseMobEditViewBase extends Vue {
     ...
     */
    protected model: any = {
        srfTitle: '项目移动端编辑视图（关闭）',
        srfCaption: 'project.views.closemobeditview.caption',
        srfSubCaption: '',
        dataInfo: '',
        viewname:'project.closemobeditview',
        iconcls: '',
        icon: ''
    }
   ...
   /**
    * 工具栏 ProjectCloseMobEditView 模型
    *
    * @type {*}
...
<style lang='less'>
@import './project-close-mob-edit-view.less';
</style>