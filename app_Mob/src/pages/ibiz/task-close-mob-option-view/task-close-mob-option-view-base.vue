...
<template>
<ion-page :className="{ 'view-container': true, 'default-mode-view': true, 'demoboptview': true, 'task-close-mob-option-view': true }">
...
export default class TaskCloseMobOptionViewBase extends Vue {
     ...
     */
    protected model: any = {
        srfTitle: '任务选项操作视图（关闭）',
        srfCaption: 'task.views.closemoboptionview.caption',
        srfSubCaption: '',
        dataInfo: '',
...
<style lang='less'>
@import './task-close-mob-option-view.less';
</style>