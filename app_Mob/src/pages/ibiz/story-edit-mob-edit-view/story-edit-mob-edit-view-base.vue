<template>
<ion-page :className="{ 'view-container': true, 'default-mode-view': true, 'demobeditview': true, 'story-edit-mob-edit-view': true }">
...
export default class StoryEditMobEditViewBase extends Vue {
	 ...
	 * @memberof StoryEditMobEditViewBase
	 */
	protected viewtag: string = '26c517c1103ef90cfe64c59190017447';
    ...
    protected model: any = {
        ...
        srfCaption: 'story.views.editmobeditview.caption',
        srfSubCaption: '',
        dataInfo: '',
        viewname:'story.editmobeditview',
        iconcls: '',
        icon: 'star-o'
    }
   ...
   /**
    * 工具栏 StoryEditMobEditView 模型
    *
    * @type {*}
    * @memberof StoryEditMobEditView
    */
...
<style lang='less'>
@import './story-edit-mob-edit-view.less';
</style>