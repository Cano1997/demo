<template>
<ion-page :className="{ 'view-container': true, 'default-mode-view': true, 'demobmpickupview': true, 'user-mob-mpickup-view': true }">
...
export default class UserMobMPickupViewBase extends Vue {
	 ...
	 * @memberof UserMobMPickupViewBase
	 */
	protected viewtag: string = '1560511b3d585976b05bba2720626f5d';
     ...
     */
    protected model: any = {
        srfTitle: '用户移动端多数据选择视图',
        srfCaption: 'user.views.mobmpickupview.caption',
        srfSubCaption: '',
        dataInfo: '',
        viewname:'user.mobmpickupview',
        iconcls: '',
        icon: ''
    }
...
<style lang='less'>
@import './user-mob-mpickup-view.less';
</style>