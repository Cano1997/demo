<template>
<ion-page :className="{ 'view-container': true, 'default-mode-view': true, 'demobmdview': true, 'story-favorite-more-mob-mdview': true }">
...
export default class StoryFavoriteMoreMobMDViewBase extends Vue {
	 ...
	 * @memberof StoryFavoriteMoreMobMDViewBase
	 */
	protected viewtag: string = '62196028f5dcb2261905206f6bf86ec6';
    ...
    protected model: any = {
        srfTitle: '需求移动端多数据视图',
        srfCaption: 'story.views.favoritemoremobmdview.caption',
        srfSubCaption: '',
        dataInfo: '',
     ...
     * @returns {Promise<any>}
     * @memberof StoryFavoriteMoreMobMDView
     */
   ...
   /**
    ...
    public openSearchform() {
      let search :any = this.$refs.searchformstoryfavoritemoremobmdview;
      if(search){
          search.open();
      }
    }
...
<style lang='less'>
@import './story-favorite-more-mob-mdview.less';
</style>