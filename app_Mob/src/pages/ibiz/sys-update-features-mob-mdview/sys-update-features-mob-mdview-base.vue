<template>
<ion-page :className="{ 'view-container': true, 'default-mode-view': true, 'demobmdview': true, 'sys-update-features-mob-mdview': true }">
...
export default class SysUpdateFeaturesMobMDViewBase extends Vue {
     ...
     */
    protected model: any = {
        srfTitle: '系统更新功能移动端多数据视图',
        srfCaption: 'sysupdatefeatures.views.mobmdview.caption',
        srfSubCaption: '',
        dataInfo: '',
        viewname:'sysupdatefeatures.mobmdview',
        iconcls: '',
        icon: ''
    }
     ...
     * @returns {Promise<any>}
     * @memberof SysUpdateFeaturesMobMDView
     */
   ...
   /**
    ...
    public openSearchform() {
      let search :any = this.$refs.searchformsysupdatefeaturesmobmdview;
      if(search){
          search.open();
      }
    }
...
<style lang='less'>
@import './sys-update-features-mob-mdview.less';
</style>