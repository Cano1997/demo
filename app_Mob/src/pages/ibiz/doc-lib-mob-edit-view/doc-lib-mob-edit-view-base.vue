...
export default class DocLibMobEditViewBase extends Vue {
    ...
    protected model: any = {
        srfTitle: '文档库移动端编辑视图',
        srfCaption: 'doclib.views.mobeditview.caption',
        srfSubCaption: '',
        dataInfo: '',
        viewname:'doclib.mobeditview',
        iconcls: '',
        icon: ''
    }
   ...
   /**
    * 工具栏 DocLibMobEditView 模型
    *
    * @type {*}
    * @memberof DocLibMobEditView
    */
...
<style lang='less'>
@import './doc-lib-mob-edit-view.less';
</style>