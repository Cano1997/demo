...
<template>
<ion-page :className="{ 'view-container': true, 'default-mode-view': true, 'demobtabexpview': true, 'ibz-weekly-usr2-mob-tab-exp-view-my-ti-jiao': true }">
...
export default class IbzWeeklyUsr2MobTabExpViewMyTiJiaoBase extends Vue {
    ...
    protected model: any = {
        srfTitle: '周报分页导航视图',
        srfCaption: 'ibzweekly.views.usr2mobtabexpviewmytijiao.caption',
        srfSubCaption: '',
        dataInfo: '',
        viewname:'ibzweekly.usr2mobtabexpviewmytijiao',
        iconcls: '',
        icon: ''
    }
...
<style lang='less'>
@import './ibz-weekly-usr2-mob-tab-exp-view-my-ti-jiao.less';
</style>