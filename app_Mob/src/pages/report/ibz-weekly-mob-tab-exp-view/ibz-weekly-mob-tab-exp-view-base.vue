...
<template>
<ion-page :className="{ 'view-container': true, 'default-mode-view': true, 'demobtabexpview': true, 'ibz-weekly-mob-tab-exp-view': true }">
...
export default class IbzWeeklyMobTabExpViewBase extends Vue {

    /**
     * 全局 ui 服务
     *
     * @type {GlobalUiService}
     * @memberof IbzWeeklyMobTabExpViewBase
     */
	 ...
	 * @memberof IbzWeeklyMobTabExpViewBase
	 */
	protected viewtag: string = 'b6ecf21481870e7c0b0f9397897bbadb';
    ...
    protected model: any = {
        srfTitle: '周报分页导航视图',
        srfCaption: 'ibzweekly.views.mobtabexpview.caption',
        srfSubCaption: '',
        dataInfo: '',
        viewname:'ibzweekly.mobtabexpview',
        iconcls: '',
        icon: ''
    }
   ...
   /**
    * 工具栏 IbzWeeklyMobTabExpView 模型
    *
    * @type {*}
    * @memberof IbzWeeklyMobTabExpView
    */
...
<style lang='less'>
@import './ibz-weekly-mob-tab-exp-view.less';
</style>