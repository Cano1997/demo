<template>
<ion-page :className="{ 'view-container': true, 'default-mode-view': true, 'demobmdview': true, 'task-my-plans-tomorrow-task-mob-mdview': true }">
...
export default class TaskMyPlansTomorrowTaskMobMDViewBase extends Vue {

    /**
     * 全局 ui 服务
     *
     * @type {GlobalUiService}
     * @memberof TaskMyPlansTomorrowTaskMobMDViewBase
     */
	 ...
	 * @memberof TaskMyPlansTomorrowTaskMobMDViewBase
	 */
	protected viewtag: string = 'e903ad26a5f15974177800895703623c';
    ...
    protected model: any = {
        ...
        srfCaption: 'task.views.myplanstomorrowtaskmobmdview.caption',
        srfSubCaption: '',
        dataInfo: '',
        viewname:'task.myplanstomorrowtaskmobmdview',
        iconcls: '',
        icon: 'tasks'
    }
   ...
   /**
    * 工具栏 TaskMyPlansTomorrowTaskMobMDView 模型
    *
    * @type {*}
    * @memberof TaskMyPlansTomorrowTaskMobMDView
    */
   ...
   /**
    ...
    public openSearchform() {
      let search :any = this.$refs.searchformtaskmyplanstomorrowtaskmobmdview;
      if(search){
          search.open();
      }
    }
...
<style lang='less'>
@import './task-my-plans-tomorrow-task-mob-mdview.less';
</style>