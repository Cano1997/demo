<template>
<ion-page :className="{ 'view-container': true, 'default-mode-view': true, 'demobeditview': true, 'ibz-weekly-mob-edit-view-main-my-tijiao': true }">
...
export default class IbzWeeklyMobEditViewMainMyTijiaoBase extends Vue {

    /**
     * 全局 ui 服务
     *
     * @type {GlobalUiService}
     * @memberof IbzWeeklyMobEditViewMainMyTijiaoBase
     */
	 ...
	 * @memberof IbzWeeklyMobEditViewMainMyTijiaoBase
	 */
	protected viewtag: string = '8143fb83617574eebbaa7f0819539924';
    ...
    protected model: any = {
        srfTitle: '周报移动端编辑视图',
        srfCaption: 'ibzweekly.views.mobeditviewmainmytijiao.caption',
        srfSubCaption: '',
        dataInfo: '',
        viewname:'ibzweekly.mobeditviewmainmytijiao',
        iconcls: '',
        icon: ''
    }
   ...
   /**
    * 工具栏 IbzWeeklyMobEditViewMainMyTijiao 模型
    *
    * @type {*}
    * @memberof IbzWeeklyMobEditViewMainMyTijiao
    */
...
<style lang='less'>
@import './ibz-weekly-mob-edit-view-main-my-tijiao.less';
</style>