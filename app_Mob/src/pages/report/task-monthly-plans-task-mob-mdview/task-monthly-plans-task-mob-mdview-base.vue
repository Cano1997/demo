<template>
<embed-view :className="{ 'view-container': true, 'default-mode-view': true, 'demobmdview9': true, 'task-monthly-plans-task-mob-mdview': true }">
    ...
    <template slot="content">
            ...
            loadAction="Get"
            createAction="Create"
            fetchAction="FetchMyPlansTaskMobMonthly" 
...
export default class TaskMonthlyPlansTaskMobMDViewBase extends Vue {

    /**
     * 全局 ui 服务
     *
     * @type {GlobalUiService}
     * @memberof TaskMonthlyPlansTaskMobMDViewBase
     */
	 ...
	 * @memberof TaskMonthlyPlansTaskMobMDViewBase
	 */
	protected viewtag: string = '54b430d78e300148f0d06da1cf52a94b';
    ...
    protected model: any = {
        srfTitle: '任务移动端多数据视图',
        srfCaption: 'task.views.monthlyplanstaskmobmdview.caption',
        srfSubCaption: '',
        dataInfo: '',
        viewname:'task.monthlyplanstaskmobmdview',
        iconcls: '',
        icon: 'tasks'
    }
     ...
     * @returns {Promise<any>}
     * @memberof TaskMonthlyPlansTaskMobMDView
     */
   ...
   /**
    ...
    public openSearchform() {
      let search :any = this.$refs.searchformtaskmonthlyplanstaskmobmdview;
      if(search){
          search.open();
      }
    }
...
<style lang='less'>
@import './task-monthly-plans-task-mob-mdview.less';
</style>