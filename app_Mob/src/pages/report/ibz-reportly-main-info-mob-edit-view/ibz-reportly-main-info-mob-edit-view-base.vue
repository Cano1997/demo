<template>
<ion-page :className="{ 'view-container': true, 'default-mode-view': true, 'demobeditview': true, 'ibz-reportly-main-info-mob-edit-view': true }">
...
import IbzReportlyUIService from '@/ui-service/ibz-reportly/ibz-reportly-ui-action';
...
export default class IbzReportlyMainInfoMobEditViewBase extends Vue {
	 ...
	 * @memberof IbzReportlyMainInfoMobEditViewBase
	 */
	protected viewtag: string = 'a2ae9ac11aa48db204b35705bf573ebd';
    ...
    protected model: any = {
        srfTitle: '汇报移动端编辑视图',
        srfCaption: 'ibzreportly.views.maininfomobeditview.caption',
        srfSubCaption: '',
        dataInfo: '',
        viewname:'ibzreportly.maininfomobeditview',
        iconcls: '',
        icon: ''
    }
   ...
   /**
    * 工具栏 IbzReportlyMainInfoMobEditView 模型
    *
    * @type {*}
    * @memberof IbzReportlyMainInfoMobEditView
    */
    public righttoolbarModels: any = {
            deuiaction1_mobedit: { name: 'deuiaction1_mobedit', disabled: false, type: 'DEUIACTION', visabled: true,noprivdisplaymode:2,dataaccaction: 'SRFUR__REPORTLY_EDIT_BUT', uiaction: { tag: 'MobEdit', target: 'SINGLEKEY' } },

            deuiaction1_mobsubmit: { name: 'deuiaction1_mobsubmit', disabled: false, type: 'DEUIACTION', visabled: true,noprivdisplaymode:2,dataaccaction: 'SRFUR__REPORTLY_SUBMIT_BUT', uiaction: { tag: 'MobSubmit', target: 'SINGLEKEY' } },
    ...
    protected async righttoolbar_deuiaction1_mobedit_click(params: any = {}, tag?: any, $event?: any): Promise<any> {
        ...
        // 界面行为
        const curUIService: any = await this.globaluiservice.getService('ibzreportly_ui_action');
        if (curUIService) {
            curUIService.IbzReportly_MobEdit(datas, contextJO, paramJO, $event, xData, this);
        }
    }
    ...
    protected async righttoolbar_deuiaction1_mobsubmit_click(params: any = {}, tag?: any, $event?: any): Promise<any> {
        ...
        const curUIService: any = await this.globaluiservice.getService('ibzreportly_ui_action');
        if (curUIService) {
            curUIService.IbzReportly_MobSubmit(datas, contextJO, paramJO, $event, xData, this);
        }
    }
...
<style lang='less'>
@import './ibz-reportly-main-info-mob-edit-view.less';
</style>