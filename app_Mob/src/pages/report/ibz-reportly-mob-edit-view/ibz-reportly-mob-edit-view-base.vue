<template>
<ion-page :className="{ 'view-container': true, 'default-mode-view': true, 'demobeditview': true, 'ibz-reportly-mob-edit-view': true }">
...
export default class IbzReportlyMobEditViewBase extends Vue {
	 ...
	 * @memberof IbzReportlyMobEditViewBase
	 */
	protected viewtag: string = 'e1db10fc06a638e6943a54a5380a6641';
    ...
    protected model: any = {
        srfTitle: '汇报移动端编辑视图',
        srfCaption: 'ibzreportly.views.mobeditview.caption',
        srfSubCaption: '',
        dataInfo: '',
        viewname:'ibzreportly.mobeditview',
        iconcls: '',
        icon: ''
    }
...
<style lang='less'>
@import './ibz-reportly-mob-edit-view.less';
</style>