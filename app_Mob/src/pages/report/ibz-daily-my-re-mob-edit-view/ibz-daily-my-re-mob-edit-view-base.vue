<template>
<ion-page :className="{ 'view-container': true, 'default-mode-view': true, 'demobeditview': true, 'ibz-daily-my-re-mob-edit-view': true }">
...
export default class IbzDailyMyReMobEditViewBase extends Vue {
     ...
     */
    protected model: any = {
        srfTitle: '日报移动端编辑视图（我收到的）',
        srfCaption: 'ibzdaily.views.myremobeditview.caption',
        srfSubCaption: '',
        dataInfo: '',
        viewname:'ibzdaily.myremobeditview',
        iconcls: '',
        icon: ''
    }
...
<style lang='less'>
@import './ibz-daily-my-re-mob-edit-view.less';
</style>