...
export default class IbzMonthlyMobEditViewBase extends Vue {
    ...
    protected model: any = {
        srfTitle: '月报移动端编辑视图',
        srfCaption: 'ibzmonthly.views.mobeditview.caption',
        srfSubCaption: '',
        dataInfo: '',
        viewname:'ibzmonthly.mobeditview',
        iconcls: '',
        icon: ''
    }
...
<style lang='less'>
@import './ibz-monthly-mob-edit-view.less';
</style>