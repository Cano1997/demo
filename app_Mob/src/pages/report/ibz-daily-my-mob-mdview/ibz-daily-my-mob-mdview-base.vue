<template>
<ion-page :className="{ 'view-container': true, 'default-mode-view': true, 'demobmdview': true, 'ibz-daily-my-mob-mdview': true }">
    ...
    <ion-footer class="view-footer">
            ...
            <div  class="bottom_button" >
                ...
                <ion-button :disabled="righttoolbarModels.deuiaction1_mobcreate.disabled" @click="righttoolbar_click({ tag: 'deuiaction1_mobcreate' }, $event),popUpGroup()" size="large">
...
export default class IbzDailyMyMobMDViewBase extends Vue {

    /**
     * 全局 ui 服务
     *
     * @type {GlobalUiService}
     * @memberof IbzDailyMyMobMDViewBase
     */
	 ...
	 * @memberof IbzDailyMyMobMDViewBase
	 */
	protected viewtag: string = '18b9f914b5fa7aa6e485660e3e5f2aaa';
     ...
     */
    protected model: any = {
        srfTitle: '日报移动端多数据视图（我的）',
        srfCaption: 'ibzdaily.views.mymobmdview.caption',
        srfSubCaption: '',
        dataInfo: '',
        viewname:'ibzdaily.mymobmdview',
        iconcls: '',
        icon: ''
    }
    ...
    */
    ...
    protected righttoolbar_click($event: any, $event2?: any) {
        if (Object.is($event.tag, 'deuiaction1_mobcreate')) {
            this.righttoolbar_deuiaction1_mobcreate_click($event, '', $event2);
        }
    }
     ...
     * @memberof IbzDailyMyMobMDViewBase
     */
    protected async righttoolbar_deuiaction1_mobcreate_click(params: any = {}, tag?: any, $event?: any): Promise<any> {
        // 参数
        ...
        if (curUIService) {
            curUIService.IbzDaily_MobCreate(datas, contextJO, paramJO, $event, xData, this);
        }
    }
   ...
   /**
    ...
    public openSearchform() {
      let search :any = this.$refs.searchformibzdailymymobmdview;
      if(search){
          search.open();
      }
    }
...
<style lang='less'>
@import './ibz-daily-my-mob-mdview.less';
</style>