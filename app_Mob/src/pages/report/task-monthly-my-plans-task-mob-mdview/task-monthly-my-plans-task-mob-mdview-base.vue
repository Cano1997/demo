<template>
<ion-page :className="{ 'view-container': true, 'default-mode-view': true, 'demobmdview': true, 'task-monthly-my-plans-task-mob-mdview': true }">
...
export default class TaskMonthlyMyPlansTaskMobMDViewBase extends Vue {
     ...
     */
    protected model: any = {
        srfTitle: '任务移动端多数据视图(我的计划参与任务)',
        srfCaption: 'task.views.monthlymyplanstaskmobmdview.caption',
        srfSubCaption: '',
        dataInfo: '',
        viewname:'task.monthlymyplanstaskmobmdview',
        iconcls: '',
        icon: 'tasks'
    }
     ...
     * @returns {Promise<any>}
     * @memberof TaskMonthlyMyPlansTaskMobMDView
     */
   ...
   /**
    ...
    public openSearchform() {
      let search :any = this.$refs.searchformtaskmonthlymyplanstaskmobmdview;
      if(search){
          search.open();
      }
    }
...
<style lang='less'>
@import './task-monthly-my-plans-task-mob-mdview.less';
</style>