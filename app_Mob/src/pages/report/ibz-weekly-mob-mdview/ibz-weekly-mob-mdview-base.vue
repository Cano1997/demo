<template>
<ion-page :className="{ 'view-container': true, 'default-mode-view': true, 'demobmdview': true, 'ibz-weekly-mob-mdview': true }">
...
export default class IbzWeeklyMobMDViewBase extends Vue {
    ...
    protected model: any = {
        srfTitle: '周报移动端多数据视图',
        srfCaption: 'ibzweekly.views.mobmdview.caption',
        srfSubCaption: '',
        dataInfo: '',
        viewname:'ibzweekly.mobmdview',
        iconcls: '',
        icon: ''
    }
   ...
   /**
    * 工具栏 IbzWeeklyMobMDView 模型
    *
    * @type {*}
    * @memberof IbzWeeklyMobMDView
    */
   ...
   /**
    ...
    public openSearchform() {
      let search :any = this.$refs.searchformibzweeklymobmdview;
      if(search){
          search.open();
      }
    }
...
<style lang='less'>
@import './ibz-weekly-mob-mdview.less';
</style>