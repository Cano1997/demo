<template>
<embed-view :className="{ 'view-container': true, 'default-mode-view': true, 'demobmdview9': true, 'task-monthly-done-task-mob-mdview': true }">
...
export default class TaskMonthlyDoneTaskMobMDViewBase extends Vue {

    /**
     * 全局 ui 服务
     *
     * @type {GlobalUiService}
     * @memberof TaskMonthlyDoneTaskMobMDViewBase
     */
	 ...
	 * @memberof TaskMonthlyDoneTaskMobMDViewBase
	 */
	protected viewtag: string = '7a2ab181ea826d269085a914d23cd49e';
    ...
    protected model: any = {
        srfTitle: '任务移动端多数据视图',
        srfCaption: 'task.views.monthlydonetaskmobmdview.caption',
        srfSubCaption: '',
        dataInfo: '',
        viewname:'task.monthlydonetaskmobmdview',
        iconcls: '',
        icon: 'tasks'
    }
     ...
     * @returns {Promise<any>}
     * @memberof TaskMonthlyDoneTaskMobMDView
     */
   ...
   /**
    ...
    public openSearchform() {
      let search :any = this.$refs.searchformtaskmonthlydonetaskmobmdview;
      if(search){
          search.open();
      }
    }
...
<style lang='less'>
@import './task-monthly-done-task-mob-mdview.less';
</style>