<template>
<ion-page :className="{ 'view-container': true, 'default-mode-view': true, 'demobeditview': true, 'ibz-monthly-my-received-mob-edit-view': true }">
...
export default class IbzMonthlyMyReceivedMobEditViewBase extends Vue {

    /**
     * 全局 ui 服务
     *
     * @type {GlobalUiService}
     * @memberof IbzMonthlyMyReceivedMobEditViewBase
     */
	 ...
	 * @memberof IbzMonthlyMyReceivedMobEditViewBase
	 */
	protected viewtag: string = '3920e1cc69e58ef6c1952f7e7e843b60';
    ...
    protected model: any = {
        srfTitle: '月报移动端编辑视图',
        srfCaption: 'ibzmonthly.views.myreceivedmobeditview.caption',
        srfSubCaption: '',
        dataInfo: '',
        viewname:'ibzmonthly.myreceivedmobeditview',
        iconcls: '',
        icon: ''
    }
...
<style lang='less'>
@import './ibz-monthly-my-received-mob-edit-view.less';
</style>