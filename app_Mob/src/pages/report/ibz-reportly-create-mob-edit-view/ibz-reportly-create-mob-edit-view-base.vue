<template>
<ion-page :className="{ 'view-container': true, 'default-mode-view': true, 'demobeditview': true, 'ibz-reportly-create-mob-edit-view': true }">
...
export default class IbzReportlyCreateMobEditViewBase extends Vue {

    /**
     * 全局 ui 服务
     *
     * @type {GlobalUiService}
     * @memberof IbzReportlyCreateMobEditViewBase
     */
	 ...
	 * @memberof IbzReportlyCreateMobEditViewBase
	 */
	protected viewtag: string = 'db8c84773e393175d84b15d23715c412';
    ...
    protected model: any = {
        srfTitle: '汇报移动端编辑视图',
        srfCaption: 'ibzreportly.views.createmobeditview.caption',
        srfSubCaption: '',
        dataInfo: '',
        viewname:'ibzreportly.createmobeditview',
        iconcls: '',
        icon: ''
    }
   ...
   /**
    * 工具栏 IbzReportlyCreateMobEditView 模型
    *
    * @type {*}
    * @memberof IbzReportlyCreateMobEditView
    */
...
<style lang='less'>
@import './ibz-reportly-create-mob-edit-view.less';
</style>