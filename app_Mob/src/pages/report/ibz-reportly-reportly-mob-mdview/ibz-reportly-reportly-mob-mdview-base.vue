<template>
<ion-page :className="{ 'view-container': true, 'default-mode-view': true, 'demobmdview': true, 'ibz-reportly-reportly-mob-mdview': true }">
    ...
    <ion-content :scroll-events="true" @ionScroll="onScroll" ref="ionScroll" @ionScrollEnd="onScrollEnd">
            ...
            loadAction="Get"
            createAction="Create"
            fetchAction="FetchMyReportlyMob" 
...
export default class IbzReportlyReportlyMobMDViewBase extends Vue {
     ...
     * @memberof IbzReportlyReportlyMobMDViewBase
     */
    protected navContext: any = { 'n_issubmit_eq': '0' };
    ...
    protected model: any = {
        srfTitle: '汇报移动端多数据视图',
        srfCaption: 'ibzreportly.views.reportlymobmdview.caption',
        srfSubCaption: '',
        dataInfo: '',
        viewname:'ibzreportly.reportlymobmdview',
        iconcls: '',
        icon: ''
    }
   ...
   /**
    * 工具栏 IbzReportlyReportlyMobMDView 模型
    *
    * @type {*}
    * @memberof IbzReportlyReportlyMobMDView
    */
    public righttoolbarModels: any = {
            deuiaction1: { name: 'deuiaction1', disabled: false, type: 'DEUIACTION', visabled: true,noprivdisplaymode:2,dataaccaction: '', uiaction: { tag: 'MobCreate', target: 'NONE' } },
    ...
    protected async righttoolbar_deuiaction1_click(params: any = {}, tag?: any, $event?: any): Promise<any> {
        ...
        if (curUIService) {
            curUIService.IbzReportly_MobCreate(datas, contextJO, paramJO, $event, xData, this);
        }
    }
   ...
   /**
    ...
    public openSearchform() {
      let search :any = this.$refs.searchformibzreportlyreportlymobmdview;
      if(search){
          search.open();
      }
    }
...
<style lang='less'>
@import './ibz-reportly-reportly-mob-mdview.less';
</style>