<template>
<ion-page :className="{ 'view-container': true, 'default-mode-view': true, 'demobmdview': true, 'task-my-complete-task-mob-mdview-next-plan-weekly': true }">
...
export default class TaskMyCompleteTaskMobMDViewNextPlanWeeklyBase extends Vue {
	 ...
	 * @memberof TaskMyCompleteTaskMobMDViewNextPlanWeeklyBase
	 */
	protected viewtag: string = 'dca81c1a74e59de75d199229ca890abb';
    ...
    protected model: any = {
        ...
        srfCaption: 'task.views.mycompletetaskmobmdviewnextplanweekly.caption',
        srfSubCaption: '',
        dataInfo: '',
        viewname:'task.mycompletetaskmobmdviewnextplanweekly',
        iconcls: '',
        icon: 'tasks'
    }
     ...
     * @returns {Promise<any>}
     * @memberof TaskMyCompleteTaskMobMDViewNextPlanWeekly
     */
   ...
   /**
    ...
    public openSearchform() {
      let search :any = this.$refs.searchformtaskmycompletetaskmobmdviewnextplanweekly;
      if(search){
          search.open();
      }
    }
...
<style lang='less'>
@import './task-my-complete-task-mob-mdview-next-plan-weekly.less';
</style>