<template>
<ion-page :className="{ 'view-container': true, 'default-mode-view': true, 'demobeditview': true, 'ibz-weekly-mob-edit-view-mian': true }">
...
export default class IbzWeeklyMobEditViewMianBase extends Vue {

    /**
     * 全局 ui 服务
     *
     * @type {GlobalUiService}
     * @memberof IbzWeeklyMobEditViewMianBase
     */
    ...
    protected model: any = {
        srfTitle: '周报移动端编辑视图',
        srfCaption: 'ibzweekly.views.mobeditviewmian.caption',
        srfSubCaption: '',
        dataInfo: '',
        viewname:'ibzweekly.mobeditviewmian',
        iconcls: '',
        icon: ''
    }
   ...
   /**
    * 工具栏 IbzWeeklyMobEditViewMian 模型
    *
    * @type {*}
    * @memberof IbzWeeklyMobEditViewMian
    */
...
<style lang='less'>
@import './ibz-weekly-mob-edit-view-mian.less';
</style>