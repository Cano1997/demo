<template>
<ion-page :className="{ 'view-container': true, 'default-mode-view': true, 'demobeditview': true, 'ibz-daily-mob-edit-view': true }">
...
export default class IbzDailyMobEditViewBase extends Vue {
	 ...
	 * @memberof IbzDailyMobEditViewBase
	 */
	protected viewtag: string = '22e33232ac91bca7826742f9c85720dc';
    ...
    protected model: any = {
        srfTitle: '日报移动端编辑视图',
        srfCaption: 'ibzdaily.views.mobeditview.caption',
        srfSubCaption: '',
        dataInfo: '',
        viewname:'ibzdaily.mobeditview',
        iconcls: '',
        icon: ''
    }
...
<style lang='less'>
@import './ibz-daily-mob-edit-view.less';
</style>