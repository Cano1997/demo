<template>
<ion-page :className="{ 'view-container': true, 'default-mode-view': true, 'demobmdview': true, 'ibz-daily-daily-complete-task-mob-mdview': true }">
...
export default class IbzDailyDailyCompleteTaskMobMDViewBase extends Vue {
    ...
    protected model: any = {
        ...
        srfCaption: 'ibzdaily.views.dailycompletetaskmobmdview.caption',
        srfSubCaption: '',
        dataInfo: '',
        viewname:'ibzdaily.dailycompletetaskmobmdview',
        iconcls: '',
        icon: ''
    }
   ...
   /**
    * 工具栏 IbzDailyDailyCompleteTaskMobMDView 模型
    *
    * @type {*}
    * @memberof IbzDailyDailyCompleteTaskMobMDView
    */
   ...
   /**
    ...
    public openSearchform() {
      let search :any = this.$refs.searchformibzdailydailycompletetaskmobmdview;
      if(search){
          search.open();
      }
    }
...
<style lang='less'>
@import './ibz-daily-daily-complete-task-mob-mdview.less';
</style>