<template>
<ion-page :className="{ 'view-container': true, 'default-mode-view': true, 'demobmdview': true, 'task-my-complete-task-mob-mdview-weekly': true }">
...
export default class TaskMyCompleteTaskMobMDViewWeeklyBase extends Vue {
	 ...
	 * @memberof TaskMyCompleteTaskMobMDViewWeeklyBase
	 */
	protected viewtag: string = '1bd9873e7212574f35571116edb7da0b';
    ...
    protected model: any = {
        ...
        srfCaption: 'task.views.mycompletetaskmobmdviewweekly.caption',
        srfSubCaption: '',
        dataInfo: '',
        viewname:'task.mycompletetaskmobmdviewweekly',
        iconcls: '',
        icon: 'tasks'
    }
     ...
     * @returns {Promise<any>}
     * @memberof TaskMyCompleteTaskMobMDViewWeekly
     */
   ...
   /**
    ...
    public openSearchform() {
      let search :any = this.$refs.searchformtaskmycompletetaskmobmdviewweekly;
      if(search){
          search.open();
      }
    }
...
<style lang='less'>
@import './task-my-complete-task-mob-mdview-weekly.less';
</style>