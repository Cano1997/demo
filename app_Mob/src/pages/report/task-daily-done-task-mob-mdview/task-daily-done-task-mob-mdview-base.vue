<template>
<embed-view :className="{ 'view-container': true, 'default-mode-view': true, 'demobmdview9': true, 'task-daily-done-task-mob-mdview': true }">
...
export default class TaskDailyDoneTaskMobMDViewBase extends Vue {

    /**
     * 全局 ui 服务
     *
     * @type {GlobalUiService}
     * @memberof TaskDailyDoneTaskMobMDViewBase
     */
	 ...
	 * @memberof TaskDailyDoneTaskMobMDViewBase
	 */
	protected viewtag: string = '3011ba0f68b10e1cbb68a70fb77e646d';
    ...
    protected model: any = {
        srfTitle: '任务移动端多数据视图',
        srfCaption: 'task.views.dailydonetaskmobmdview.caption',
        srfSubCaption: '',
        dataInfo: '',
        viewname:'task.dailydonetaskmobmdview',
        iconcls: '',
        icon: 'tasks'
    }
     ...
     * @returns {Promise<any>}
     * @memberof TaskDailyDoneTaskMobMDView
     */
   ...
   /**
    ...
    public openSearchform() {
      let search :any = this.$refs.searchformtaskdailydonetaskmobmdview;
      if(search){
          search.open();
      }
    }
...
<style lang='less'>
@import './task-daily-done-task-mob-mdview.less';
</style>