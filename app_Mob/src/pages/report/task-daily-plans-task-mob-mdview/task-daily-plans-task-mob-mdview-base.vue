<template>
<embed-view :className="{ 'view-container': true, 'default-mode-view': true, 'demobmdview9': true, 'task-daily-plans-task-mob-mdview': true }">
...
export default class TaskDailyPlansTaskMobMDViewBase extends Vue {
    ...
    protected model: any = {
        srfTitle: '任务移动端多数据视图',
        srfCaption: 'task.views.dailyplanstaskmobmdview.caption',
        srfSubCaption: '',
        dataInfo: '',
        viewname:'task.dailyplanstaskmobmdview',
        iconcls: '',
        icon: 'tasks'
    }
     ...
     * @returns {Promise<any>}
     * @memberof TaskDailyPlansTaskMobMDView
     */
   ...
   /**
    ...
    public openSearchform() {
      let search :any = this.$refs.searchformtaskdailyplanstaskmobmdview;
      if(search){
          search.open();
      }
    }
...
<style lang='less'>
@import './task-daily-plans-task-mob-mdview.less';
</style>