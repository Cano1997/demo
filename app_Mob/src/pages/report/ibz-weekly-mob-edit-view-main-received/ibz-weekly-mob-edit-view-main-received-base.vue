...
export default class IbzWeeklyMobEditViewMainReceivedBase extends Vue {

    /**
     * 全局 ui 服务
     *
     * @type {GlobalUiService}
     * @memberof IbzWeeklyMobEditViewMainReceivedBase
     */
	 ...
	 * @memberof IbzWeeklyMobEditViewMainReceivedBase
	 */
	protected viewtag: string = 'fbca44c9e6b602b694348be947f36525';
    ...
    protected model: any = {
        srfTitle: '周报移动端编辑视图',
        srfCaption: 'ibzweekly.views.mobeditviewmainreceived.caption',
        srfSubCaption: '',
        dataInfo: '',
        viewname:'ibzweekly.mobeditviewmainreceived',
        iconcls: '',
        icon: ''
    }
   ...
   /**
    * 工具栏 IbzWeeklyMobEditViewMainReceived 模型
    *
    * @type {*}
    * @memberof IbzWeeklyMobEditViewMainReceived
    */
...
<style lang='less'>
@import './ibz-weekly-mob-edit-view-main-received.less';
</style>