<template>
<ion-page :className="{ 'view-container': true, 'default-mode-view': true, 'demobeditview': true, 'ibz-monthly-create-mob-edit-view': true }">
...
export default class IbzMonthlyCreateMobEditViewBase extends Vue {

    /**
     * 全局 ui 服务
     *
     * @type {GlobalUiService}
     * @memberof IbzMonthlyCreateMobEditViewBase
     */
	 ...
	 * @memberof IbzMonthlyCreateMobEditViewBase
	 */
	protected viewtag: string = 'd5dfb8e49ac109dec6ea502b80cb4419';
    ...
    protected model: any = {
        srfTitle: '月报移动端编辑视图',
        srfCaption: 'ibzmonthly.views.createmobeditview.caption',
        srfSubCaption: '',
        dataInfo: '',
        viewname:'ibzmonthly.createmobeditview',
        iconcls: '',
        icon: ''
    }
   ...
   /**
    * 工具栏 IbzMonthlyCreateMobEditView 模型
    *
    * @type {*}
    * @memberof IbzMonthlyCreateMobEditView
    */
...
<style lang='less'>
@import './ibz-monthly-create-mob-edit-view.less';
</style>