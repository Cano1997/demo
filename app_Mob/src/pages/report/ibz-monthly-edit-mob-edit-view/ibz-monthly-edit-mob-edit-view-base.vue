<template>
<ion-page :className="{ 'view-container': true, 'default-mode-view': true, 'demobeditview': true, 'ibz-monthly-edit-mob-edit-view': true }">
...
export default class IbzMonthlyEditMobEditViewBase extends Vue {

    /**
     * 全局 ui 服务
     *
     * @type {GlobalUiService}
     * @memberof IbzMonthlyEditMobEditViewBase
     */
	 ...
	 * @memberof IbzMonthlyEditMobEditViewBase
	 */
	protected viewtag: string = '6b3a86f189808eac904d838523fea64f';
    ...
    protected model: any = {
        srfTitle: '月报移动端编辑视图',
        srfCaption: 'ibzmonthly.views.editmobeditview.caption',
        srfSubCaption: '',
        dataInfo: '',
        viewname:'ibzmonthly.editmobeditview',
        iconcls: '',
        icon: ''
    }
   ...
   /**
    * 工具栏 IbzMonthlyEditMobEditView 模型
    *
    * @type {*}
    * @memberof IbzMonthlyEditMobEditView
    */
...
<style lang='less'>
@import './ibz-monthly-edit-mob-edit-view.less';
</style>