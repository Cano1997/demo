...
<template>
<ion-page :className="{ 'view-container': true, 'default-mode-view': true, 'demobtabexpview': true, 'ibz-weekly-usr2-mob-tab-exp-view': true }">
...
export default class IbzWeeklyUsr2MobTabExpViewBase extends Vue {
	 ...
	 * @memberof IbzWeeklyUsr2MobTabExpViewBase
	 */
	protected viewtag: string = '339eb0f210b333b047528dcd30df2dde';
    ...
    protected model: any = {
        srfTitle: '周报分页导航视图',
        srfCaption: 'ibzweekly.views.usr2mobtabexpview.caption',
        srfSubCaption: '',
        dataInfo: '',
        viewname:'ibzweekly.usr2mobtabexpview',
        iconcls: '',
        icon: ''
    }
...
<style lang='less'>
@import './ibz-weekly-usr2-mob-tab-exp-view.less';
</style>