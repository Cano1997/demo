...
<template>
<ion-page :className="{ 'view-container': true, 'default-mode-view': true, 'demobtabexpview': true, 'ibz-daily-daily-mob-tab-exp-view': true }">
...
export default class IbzDailyDailyMobTabExpViewBase extends Vue {
	 ...
	 * @memberof IbzDailyDailyMobTabExpViewBase
	 */
	protected viewtag: string = '5cf685aa2765b112906a6b8ed57cdfc1';
    ...
    protected model: any = {
        srfTitle: '日报分页导航视图',
        srfCaption: 'ibzdaily.views.dailymobtabexpview.caption',
        srfSubCaption: '',
        dataInfo: '',
        viewname:'ibzdaily.dailymobtabexpview',
        iconcls: '',
        icon: ''
    }
    ...
    *
    * @type {*}
    * @memberof IbzDailyDailyMobTabExpView
    */
...
<style lang='less'>
@import './ibz-daily-daily-mob-tab-exp-view.less';
</style>