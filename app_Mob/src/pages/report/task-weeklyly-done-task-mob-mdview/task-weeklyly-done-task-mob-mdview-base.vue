<template>
<embed-view :className="{ 'view-container': true, 'default-mode-view': true, 'demobmdview9': true, 'task-weeklyly-done-task-mob-mdview': true }">
    ...
    <template slot="content">
            ...
            loadAction="Get"
            createAction="Create"
            fetchAction="FetchThisWeekCompleteTaskMobZS" 
...
export default class TaskWeeklylyDoneTaskMobMDViewBase extends Vue {

    /**
     * 全局 ui 服务
     *
     * @type {GlobalUiService}
     * @memberof TaskWeeklylyDoneTaskMobMDViewBase
     */
	 ...
	 * @memberof TaskWeeklylyDoneTaskMobMDViewBase
	 */
	protected viewtag: string = 'da2e1d94069e11c5bdcc6142606100b2';
    ...
    protected model: any = {
        srfTitle: '任务移动端多数据视图',
        srfCaption: 'task.views.weeklylydonetaskmobmdview.caption',
        srfSubCaption: '',
        dataInfo: '',
        viewname:'task.weeklylydonetaskmobmdview',
        iconcls: '',
        icon: 'tasks'
    }
     ...
     * @returns {Promise<any>}
     * @memberof TaskWeeklylyDoneTaskMobMDView
     */
   ...
   /**
    ...
    public openSearchform() {
      let search :any = this.$refs.searchformtaskweeklylydonetaskmobmdview;
      if(search){
          search.open();
      }
    }
...
<style lang='less'>
@import './task-weeklyly-done-task-mob-mdview.less';
</style>