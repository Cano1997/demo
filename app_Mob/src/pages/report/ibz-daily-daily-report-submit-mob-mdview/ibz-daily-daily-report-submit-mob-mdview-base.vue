<template>
<ion-page :className="{ 'view-container': true, 'default-mode-view': true, 'demobmdview': true, 'ibz-daily-daily-report-submit-mob-mdview': true }">
    ...
    <ion-content :scroll-events="true" @ionScroll="onScroll" ref="ionScroll" @ionScrollEnd="onScrollEnd">
            ...
            loadAction="Get"
            createAction="Create"
            fetchAction="FetchMySubmitDaily" 
...
export default class IbzDailyDailyReportSubmitMobMDViewBase extends Vue {
    ...
    protected model: any = {
        ...
        srfCaption: 'ibzdaily.views.dailyreportsubmitmobmdview.caption',
        srfSubCaption: '',
        dataInfo: '',
        viewname:'ibzdaily.dailyreportsubmitmobmdview',
        iconcls: '',
        icon: ''
    }
   ...
   /**
    * 工具栏 IbzDailyDailyReportSubmitMobMDView 模型
    *
    * @type {*}
    * @memberof IbzDailyDailyReportSubmitMobMDView
    */
   ...
   /**
    ...
    public openSearchform() {
      let search :any = this.$refs.searchformibzdailydailyreportsubmitmobmdview;
      if(search){
          search.open();
      }
    }
...
<style lang='less'>
@import './ibz-daily-daily-report-submit-mob-mdview.less';
</style>