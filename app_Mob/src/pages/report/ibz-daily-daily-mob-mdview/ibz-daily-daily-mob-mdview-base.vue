<template>
<ion-page :className="{ 'view-container': true, 'default-mode-view': true, 'demobmdview': true, 'ibz-daily-daily-mob-mdview': true }">
...
export default class IbzDailyDailyMobMDViewBase extends Vue {

    /**
     * 全局 ui 服务
     *
     * @type {GlobalUiService}
     * @memberof IbzDailyDailyMobMDViewBase
     */
	 ...
	 * @memberof IbzDailyDailyMobMDViewBase
	 */
	protected viewtag: string = '983fc79effc6ccd4d63f0b957c37efe1';
     ...
     */
    protected model: any = {
        srfTitle: '日报移动端多数据视图（主数据）',
        srfCaption: 'ibzdaily.views.dailymobmdview.caption',
        srfSubCaption: '',
        dataInfo: '',
        viewname:'ibzdaily.dailymobmdview',
        iconcls: '',
        icon: ''
    }
   ...
   /**
    * 工具栏 IbzDailyDailyMobMDView 模型
    *
    * @type {*}
    * @memberof IbzDailyDailyMobMDView
    */
   ...
   /**
    ...
    public openSearchform() {
      let search :any = this.$refs.searchformibzdailydailymobmdview;
      if(search){
          search.open();
      }
    }
...
<style lang='less'>
@import './ibz-daily-daily-mob-mdview.less';
</style>