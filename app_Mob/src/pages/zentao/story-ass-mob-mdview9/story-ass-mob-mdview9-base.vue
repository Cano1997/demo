<template>
<embed-view :className="{ 'view-container': true, 'default-mode-view': true, 'demobmdview9': true, 'story-ass-mob-mdview9': true }">
...
export default class StoryAssMobMDView9Base extends Vue {
   ...
   /**
    ...
    public openSearchform() {
      let search :any = this.$refs.searchformstoryassmobmdview9;
      if(search){
          search.open();
      }
    }
...
<style lang='less'>
@import './story-ass-mob-mdview9.less';
</style>