<template>
<ion-page :className="{ 'view-container': true, 'default-mode-view': true, 'demobeditview': true, 'user-user-center-mob-edit-view': true }">
...
export default class UserUserCenterMobEditViewBase extends Vue {
     ...
     * @memberof UserUserCenterMobEditViewBase
     */
    protected navParam: any = { 'user': '%srfuserid%' };
...
<style lang='less'>
@import './user-user-center-mob-edit-view.less';
</style>