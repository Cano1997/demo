<template>
<ion-page :className="{ 'view-container': true, 'default-mode-view': true, 'demobmdview': true, 'action-more-mob-mdview': true }">
...
export default class ActionMoreMobMDViewBase extends Vue {
     ...
     */
    protected model: any = {
        srfTitle: '系统日志移动端多数据视图（更多）',
        srfCaption: 'action.views.moremobmdview.caption',
        srfSubCaption: '',
        dataInfo: '',
        viewname:'action.moremobmdview',
        iconcls: '',
        icon: ''
    }
   ...
   /**
    ...
    public openSearchform() {
      let search :any = this.$refs.searchformactionmoremobmdview;
      if(search){
          search.open();
      }
    }
...
<style lang='less'>
@import './action-more-mob-mdview.less';
</style>