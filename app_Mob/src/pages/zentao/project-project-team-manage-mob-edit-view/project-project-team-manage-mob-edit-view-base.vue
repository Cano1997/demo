<template>
<ion-page :className="{ 'view-container': true, 'default-mode-view': true, 'demobeditview': true, 'project-project-team-manage-mob-edit-view': true }">
...
export default class ProjectProjectTeamManageMobEditViewBase extends Vue {
    ...
    protected model: any = {
        srfTitle: '项目移动端编辑视图',
        srfCaption: 'project.views.projectteammanagemobeditview.caption',
        srfSubCaption: '',
        dataInfo: '',
        viewname:'project.projectteammanagemobeditview',
        iconcls: '',
        icon: ''
    }
   ...
   /**
    * 工具栏 ProjectProjectTeamManageMobEditView 模型
    *
    * @type {*}
    * @memberof ProjectProjectTeamManageMobEditView
    */
...
<style lang='less'>
@import './project-project-team-manage-mob-edit-view.less';
</style>