<template>
<embed-view :className="{ 'view-container': true, 'default-mode-view': true, 'demobmdview9': true, 'story-usr2-mob-mdview9': true }">
...
export default class StoryUsr2MobMDView9Base extends Vue {

    /**
     * 全局 ui 服务
     *
     * @type {GlobalUiService}
     * @memberof StoryUsr2MobMDView9Base
     */
	 ...
	 * @memberof StoryUsr2MobMDView9Base
	 */
	protected viewtag: string = '897b1cde235b8de7aebfde36d4731410';
    ...
    protected model: any = {
        srfTitle: '需求移动端多数据视图',
        srfCaption: 'story.views.usr2mobmdview9.caption',
        srfSubCaption: '',
        dataInfo: '',
        viewname:'story.usr2mobmdview9',
        iconcls: '',
        icon: 'star-o'
    }
   ...
   /**
    * 工具栏 StoryUsr2MobMDView9 模型
    *
    * @type {*}
    * @memberof StoryUsr2MobMDView9
    */
   ...
   /**
    ...
    public openSearchform() {
      let search :any = this.$refs.searchformstoryusr2mobmdview9;
      if(search){
          search.open();
      }
    }
...
<style lang='less'>
@import './story-usr2-mob-mdview9.less';
</style>