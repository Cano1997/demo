<template>
<ion-page :className="{ 'view-container': true, 'default-mode-view': true, 'demobeditview': true, 'task-new-mob-edit-view': true }">
...
export default class TaskNewMobEditViewBase extends Vue {
	 ...
	 * @memberof TaskNewMobEditViewBase
	 */
	protected viewtag: string = 'e6b8dc7c5f604f8cc4cabb89752aac17';
   ...
   /**
    * 工具栏 TaskNewMobEditView 模型
    *
    * @type {*}
    * @memberof TaskNewMobEditView
    */
...
<style lang='less'>
@import './task-new-mob-edit-view.less';
</style>