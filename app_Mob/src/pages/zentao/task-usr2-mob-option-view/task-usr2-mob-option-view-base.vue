...
<template>
<ion-page :className="{ 'view-container': true, 'default-mode-view': true, 'demoboptview': true, 'task-usr2-mob-option-view': true }">
    ...
    <ion-content >
            ...
            loadAction="GetTeamUserLeftStart"
...
export default class TaskUsr2MobOptionViewBase extends Vue {
     ...
     */
    protected model: any = {
        srfTitle: '任务选项操作视图(继续)',
        srfCaption: 'task.views.usr2moboptionview.caption',
        srfSubCaption: '',
        dataInfo: '',
        viewname:'task.usr2moboptionview',
        iconcls: '',
        icon: 'tasks'
    }
...
<style lang='less'>
@import './task-usr2-mob-option-view.less';
</style>