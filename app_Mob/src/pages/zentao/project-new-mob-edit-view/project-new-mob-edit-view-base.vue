...
export default class ProjectNewMobEditViewBase extends Vue {
	 ...
	 * @memberof ProjectNewMobEditViewBase
	 */
	protected viewtag: string = '25c88b88ef4d39886b97fe4efd5d6568';
     ...
     */
    protected model: any = {
        srfTitle: '项目移动端编辑视图（新建）',
        srfCaption: 'project.views.newmobeditview.caption',
        srfSubCaption: '',
        dataInfo: '',
        viewname:'project.newmobeditview',
        iconcls: '',
        icon: ''
    }
   ...
   /**
    * 工具栏 ProjectNewMobEditView 模型
    *
    * @type {*}
    * @memberof ProjectNewMobEditView
    */
...
<style lang='less'>
@import './project-new-mob-edit-view.less';
</style>