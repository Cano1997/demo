<template>
<embed-view :className="{ 'view-container': true, 'default-mode-view': true, 'demobmdview9': true, 'bug-mob-mdview9': true }">
...
export default class BugMobMDView9Base extends Vue {

    /**
     * 全局 ui 服务
     *
     * @type {GlobalUiService}
     * @memberof BugMobMDView9Base
     */
	 ...
	 * @memberof BugMobMDView9Base
	 */
	protected viewtag: string = '93adfcb3ea22ac270a2603f7f2226a38';
    ...
    protected model: any = {
        ...
        srfCaption: 'bug.views.mobmdview9.caption',
        srfSubCaption: '',
        dataInfo: '',
        viewname:'bug.mobmdview9',
        iconcls: '',
        icon: 'bug'
    }
   ...
   /**
    * 工具栏 BugMobMDView9 模型
    *
    * @type {*}
    * @memberof BugMobMDView9
    */
   ...
   /**
    ...
    public openSearchform() {
      let search :any = this.$refs.searchformbugmobmdview9;
      if(search){
          search.open();
      }
    }
