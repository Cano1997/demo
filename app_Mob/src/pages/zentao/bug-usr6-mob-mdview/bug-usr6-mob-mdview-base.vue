...
export default class BugUsr6MobMDViewBase extends Vue {
	 ...
	 * @memberof BugUsr6MobMDViewBase
	 */
	protected viewtag: string = 'fb9c24d670e38ce76584ef9e3e800d1f';
    ...
    protected model: any = {
        ...
        srfCaption: 'bug.views.usr6mobmdview.caption',
        srfSubCaption: '',
        dataInfo: '',
        viewname:'bug.usr6mobmdview',
        iconcls: '',
        icon: 'bug'
    }
   ...
   /**
    * 工具栏 BugUsr6MobMDView 模型
    *
    * @type {*}
    * @memberof BugUsr6MobMDView
    */
    public righttoolbarModels: any = {
            deuiaction1: { name: 'deuiaction1', disabled: false, type: 'DEUIACTION', visabled: true,noprivdisplaymode:2,dataaccaction: '', uiaction: { tag: 'MobProductPlanLinkBug', target: 'NONE' } },
    ...
    protected async righttoolbar_deuiaction1_click(params: any = {}, tag?: any, $event?: any): Promise<any> {
        ...
        if (curUIService) {
            curUIService.Bug_MobProductPlanLinkBug(datas, contextJO, paramJO, $event, xData, this);
        }
    }
   ...
   /**
    ...
    public openSearchform() {
      let search :any = this.$refs.searchformbugusr6mobmdview;
      if(search){
          search.open();
      }
    }
...
<style lang='less'>
@import './bug-usr6-mob-mdview.less';
</style>