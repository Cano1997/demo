<template>
<ion-page :className="{ 'view-container': true, 'default-mode-view': true, 'demobmpickupview': true, 'bug-usr3-mob-mpickup-build-create-bug-view': true }">
...
export default class BugUsr3MobMPickupBuildCreateBugViewBase extends Vue {
    ...
    protected model: any = {
        ...
        srfCaption: 'bug.views.usr3mobmpickupbuildcreatebugview.caption',
        srfSubCaption: '',
        dataInfo: '',
        viewname:'bug.usr3mobmpickupbuildcreatebugview',
        iconcls: '',
        icon: 'bug'
    }
     ...
     *
     * @type {any[]}
     * @memberof BugUsr3MobMPickupBuildCreateBugView
     */
...
<style lang='less'>
@import './bug-usr3-mob-mpickup-build-create-bug-view.less';
</style>