...
export default class ProductCloseMobEditViewBase extends Vue {
	 ...
	 * @memberof ProductCloseMobEditViewBase
	 */
	protected viewtag: string = 'c7a80e4f493974e2e06f5ae3ff9dc72c';
   ...
   /**
    * 工具栏 ProductCloseMobEditView 模型
    *
    * @type {*}
...
<style lang='less'>
@import './product-close-mob-edit-view.less';
</style>