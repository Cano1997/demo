...
<template>
<ion-page :className="{ 'view-container': true, 'default-mode-view': true, 'demoboptview': true, 'story-mob-option-view': true }">
...
export default class StoryMobOptionViewBase extends Vue {
	 ...
	 * @memberof StoryMobOptionViewBase
	 */
	protected viewtag: string = '5de478b9876d5aa79de141207737d7fc';
     ...
     */
    protected model: any = {
        srfTitle: '需求选项需求实体移动端选项操作视图(项目按照计划关联)视图',
        srfCaption: 'story.views.moboptionview.caption',
        srfSubCaption: '',
        dataInfo: '',
        viewname:'story.moboptionview',
        iconcls: '',
        icon: 'star-o'
    }
...
<style lang='less'>
@import './story-mob-option-view.less';
</style>