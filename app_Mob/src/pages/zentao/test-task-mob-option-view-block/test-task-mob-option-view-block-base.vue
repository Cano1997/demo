...
<template>
<ion-page :className="{ 'view-container': true, 'default-mode-view': true, 'demoboptview': true, 'test-task-mob-option-view-block': true }">
...
export default class TestTaskMobOptionViewBlockBase extends Vue {
    ...
    protected model: any = {
        ...
        srfCaption: 'testtask.views.moboptionviewblock.caption',
        srfSubCaption: '',
        dataInfo: '',
        viewname:'testtask.moboptionviewblock',
        iconcls: '',
        icon: 'clipboard'
    }
...
<style lang='less'>
@import './test-task-mob-option-view-block.less';
</style>