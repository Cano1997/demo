<template>
<ion-page :className="{ 'view-container': true, 'default-mode-view': true, 'demobeditview': true, 'project-team-project-team-all-mob-edit-view': true }">
...
export default class ProjectTeamProjectTeamAllMobEditViewBase extends Vue {

    /**
     * 全局 ui 服务
     *
     * @type {GlobalUiService}
     * @memberof ProjectTeamProjectTeamAllMobEditViewBase
     */
	 ...
	 * @memberof ProjectTeamProjectTeamAllMobEditViewBase
	 */
	protected viewtag: string = '33d53911e52105c767147382ddf5e140';
     ...
     */
    protected model: any = {
        srfTitle: '项目团队移动端编辑视图',
        srfCaption: 'projectteam.views.projectteamallmobeditview.caption',
        srfSubCaption: '',
        dataInfo: '',
        viewname:'projectteam.projectteamallmobeditview',
        iconcls: '',
        icon: 'users'
    }
   ...
   /**
    * 工具栏 ProjectTeamProjectTeamAllMobEditView 模型
    *
    * @type {*}
    * @memberof ProjectTeamProjectTeamAllMobEditView
    */
...
<style lang='less'>
@import './project-team-project-team-all-mob-edit-view.less';
</style>