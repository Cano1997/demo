...
<template>
<ion-page :className="{ 'view-container': true, 'default-mode-view': true, 'demoboptview': true, 'test-task-mob-option-view-start': true }">
...
export default class TestTaskMobOptionViewStartBase extends Vue {

    /**
     * 全局 ui 服务
     *
     * @type {GlobalUiService}
     * @memberof TestTaskMobOptionViewStartBase
     */
	 ...
	 * @memberof TestTaskMobOptionViewStartBase
	 */
	protected viewtag: string = '51d18e10db20ac282c1154bac5fa9b8f';
     ...
     */
    protected model: any = {
        srfTitle: '测试版本选项操作视图（开始）',
        srfCaption: 'testtask.views.moboptionviewstart.caption',
        srfSubCaption: '',
        dataInfo: '',
        viewname:'testtask.moboptionviewstart',
        iconcls: '',
        icon: 'clipboard'
    }
...
<style lang='less'>
@import './test-task-mob-option-view-start.less';
</style>