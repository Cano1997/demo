<template>
<ion-page :className="{ 'view-container': true, 'default-mode-view': true, 'demobmpickupview': true, 'bug-usr3-mob-mpickup-left-view': true }">
...
export default class BugUsr3MobMPickupLeftViewBase extends Vue {
    ...
    protected model: any = {
        ...
        srfCaption: 'bug.views.usr3mobmpickupleftview.caption',
        srfSubCaption: '',
        dataInfo: '',
        viewname:'bug.usr3mobmpickupleftview',
        iconcls: '',
        icon: 'bug'
    }
     ...
     *
     * @type {any[]}
     * @memberof BugUsr3MobMPickupLeftView
     */
...
<style lang='less'>
@import './bug-usr3-mob-mpickup-left-view.less';
</style>