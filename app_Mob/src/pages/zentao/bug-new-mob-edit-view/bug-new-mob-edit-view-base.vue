...
export default class BugNewMobEditViewBase extends Vue {
	 ...
	 * @memberof BugNewMobEditViewBase
	 */
	protected viewtag: string = '8d563db931fa920ad348c866d5c92ff2';
    ...
    protected model: any = {
        ...
        srfCaption: 'bug.views.newmobeditview.caption',
        srfSubCaption: '',
        dataInfo: '',
...
<style lang='less'>
@import './bug-new-mob-edit-view.less';
</style>