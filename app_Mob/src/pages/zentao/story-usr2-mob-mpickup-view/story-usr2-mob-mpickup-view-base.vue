...
export default class StoryUsr2MobMPickupViewBase extends Vue {

    /**
     * 全局 ui 服务
     *
     * @type {GlobalUiService}
     * @memberof StoryUsr2MobMPickupViewBase
     */
	 ...
	 * @memberof StoryUsr2MobMPickupViewBase
	 */
	protected viewtag: string = '85de6d83db3b382b8448740bc09027db';
    ...
    protected model: any = {
        ...
        srfCaption: 'story.views.usr2mobmpickupview.caption',
        srfSubCaption: '',
        dataInfo: '',
        viewname:'story.usr2mobmpickupview',
        iconcls: '',
        icon: 'star-o'
    }
     ...
     *
     * @type {any[]}
     * @memberof StoryUsr2MobMPickupView
     */
...
<style lang='less'>
@import './story-usr2-mob-mpickup-view.less';
</style>