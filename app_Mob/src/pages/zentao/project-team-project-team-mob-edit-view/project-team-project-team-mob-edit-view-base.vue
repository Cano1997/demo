<template>
<embed-view :className="{ 'view-container': true, 'default-mode-view': true, 'demobeditview9': true, 'project-team-project-team-mob-edit-view': true }">
...
export default class ProjectTeamProjectTeamMobEditViewBase extends Vue {

    /**
     * 全局 ui 服务
     *
     * @type {GlobalUiService}
     * @memberof ProjectTeamProjectTeamMobEditViewBase
     */
	 ...
	 * @memberof ProjectTeamProjectTeamMobEditViewBase
	 */
	protected viewtag: string = '86e2021c8b8622f5936942427ca7f18b';
    ...
    protected model: any = {
        ...
        srfCaption: 'projectteam.views.projectteammobeditview.caption',
        srfSubCaption: '',
        dataInfo: '',
        viewname:'projectteam.projectteammobeditview',
        iconcls: '',
        icon: 'users'
    }
   ...
   /**
    * 工具栏 ProjectTeamProjectTeamMobEditView 模型
    *
    * @type {*}
    * @memberof ProjectTeamProjectTeamMobEditView
    */
...
<style lang='less'>
@import './project-team-project-team-mob-edit-view.less';
</style>