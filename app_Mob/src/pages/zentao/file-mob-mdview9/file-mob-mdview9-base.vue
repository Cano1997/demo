<template>
<embed-view :className="{ 'view-container': true, 'default-mode-view': true, 'demobmdview9': true, 'file-mob-mdview9': true }">
...
export default class FileMobMDView9Base extends Vue {
    ...
    protected model: any = {
        srfTitle: '附件移动端多数据视图',
        srfCaption: 'file.views.mobmdview9.caption',
        srfSubCaption: '',
        dataInfo: '',
        viewname:'file.mobmdview9',
        iconcls: '',
        icon: ''
    }
   ...
   /**
    ...
    public openSearchform() {
      let search :any = this.$refs.searchformfilemobmdview9;
      if(search){
          search.open();
      }
    }
