...
export default class StoryUsr2MobMDViewBase extends Vue {
	 ...
	 * @memberof StoryUsr2MobMDViewBase
	 */
	protected viewtag: string = '266b8e9626971dd7c27caa3bdea264d5';
    ...
    protected model: any = {
        srfTitle: '需求移动端多数据视图',
        srfCaption: 'story.views.usr2mobmdview.caption',
        srfSubCaption: '',
        dataInfo: '',
        viewname:'story.usr2mobmdview',
        iconcls: '',
        icon: 'star-o'
    }
   ...
   /**
    ...
    public openSearchform() {
      let search :any = this.$refs.searchformstoryusr2mobmdview;
      if(search){
          search.open();
      }
    }
...
<style lang='less'>
@import './story-usr2-mob-mdview.less';
</style>