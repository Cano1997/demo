...
<template>
<ion-page :className="{ 'view-container': true, 'default-mode-view': true, 'demoboptview': true, 'test-task-mob-option-view-activite': true }">
...
export default class TestTaskMobOptionViewActiviteBase extends Vue {
     ...
     */
    protected model: any = {
        srfTitle: '测试版本选项操作视图（激活）',
        srfCaption: 'testtask.views.moboptionviewactivite.caption',
        srfSubCaption: '',
        dataInfo: '',
        viewname:'testtask.moboptionviewactivite',
        iconcls: '',
        icon: 'clipboard'
    }
...
<style lang='less'>
@import './test-task-mob-option-view-activite.less';
</style>