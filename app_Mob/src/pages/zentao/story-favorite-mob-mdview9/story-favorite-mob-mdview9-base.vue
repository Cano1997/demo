...
export default class StoryFavoriteMobMDView9Base extends Vue {
   ...
   /**
    ...
    public openSearchform() {
      let search :any = this.$refs.searchformstoryfavoritemobmdview9;
      if(search){
          search.open();
      }
    }
...
<style lang='less'>
@import './story-favorite-mob-mdview9.less';
</style>