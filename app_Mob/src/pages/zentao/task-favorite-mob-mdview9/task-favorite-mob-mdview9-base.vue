<template>
<embed-view :className="{ 'view-container': true, 'default-mode-view': true, 'demobmdview9': true, 'task-favorite-mob-mdview9': true }">
...
export default class TaskFavoriteMobMDView9Base extends Vue {
    ...
    protected model: any = {
        srfTitle: '任务移动端多数据视图',
        srfCaption: 'task.views.favoritemobmdview9.caption',
        srfSubCaption: '',
        dataInfo: '',
        viewname:'task.favoritemobmdview9',
        iconcls: '',
        icon: 'tasks'
    }
   ...
   /**
    ...
    public openSearchform() {
      let search :any = this.$refs.searchformtaskfavoritemobmdview9;
      if(search){
          search.open();
      }
    }
...
<style lang='less'>
@import './task-favorite-mob-mdview9.less';
</style>