<template>
<ion-page :className="{ 'view-container': true, 'default-mode-view': true, 'demobmdview': true, 'bug-usr2-mob-mdview': true }">
    ...
    <ion-header>
        <app-search-history @quickValueChange="quickValueChange" :model="model" :showfilter="false"></app-search-history>
                ...
                <div class="bug-usr2-mob-mdview-toolbar default-sort">
                    <div class="view-tool">
...
export default class BugUsr2MobMDViewBase extends Vue {

    /**
     * 全局 ui 服务
     *
     * @type {GlobalUiService}
     * @memberof BugUsr2MobMDViewBase
     */
	 ...
	 * @memberof BugUsr2MobMDViewBase
	 */
	protected viewtag: string = 'facbb60c5f02c64a515fefaeaff1424f';
    ...
    protected model: any = {
        ...
        srfCaption: 'bug.views.usr2mobmdview.caption',
        srfSubCaption: '',
        dataInfo: '',
        viewname:'bug.usr2mobmdview',
        iconcls: '',
        icon: 'bug'
    }
   ...
   /**
    * 工具栏 BugUsr2MobMDView 模型
    *
    * @type {*}
    * @memberof BugUsr2MobMDView
    */
    public righttoolbarModels: any = {
            deuiaction1: { name: 'deuiaction1', disabled: false, type: 'DEUIACTION', visabled: true,noprivdisplaymode:2,dataaccaction: '', uiaction: { tag: 'MobReleaseLinkResolvedBug', target: 'NONE' } },
    ...
    protected async righttoolbar_deuiaction1_click(params: any = {}, tag?: any, $event?: any): Promise<any> {
        ...
        if (curUIService) {
            curUIService.Bug_MobReleaseLinkResolvedBug(datas, contextJO, paramJO, $event, xData, this);
        }
    }
   ...
   /**
    ...
    public openSearchform() {
      let search :any = this.$refs.searchformbugusr2mobmdview;
      if(search){
          search.open();
      }
    }
...
<style lang='less'>
@import './bug-usr2-mob-mdview.less';
</style>