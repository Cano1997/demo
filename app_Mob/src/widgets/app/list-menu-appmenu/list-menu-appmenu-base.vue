...
import ListMenuService from '@/app-core/ctrl-service/app/list-menu-appmenu-service';
...
export default class ListMenuBase extends Vue implements ControlInterface {
     ...
     * @memberof ListMenu
     */
    public menuMode: ListMenuModel = new ListMenuModel();
