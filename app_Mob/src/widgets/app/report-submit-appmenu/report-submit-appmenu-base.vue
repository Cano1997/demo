...
import ReportSubmitService from '@/app-core/ctrl-service/app/report-submit-appmenu-service';
...
export default class ReportSubmitBase extends Vue implements ControlInterface {
     ...
     * 建构部件服务对象
     *
     * @type {ReportSubmitService}
     * @memberof ReportSubmit
     */
    protected service: ReportSubmitService = new ReportSubmitService({$store:this.$store});
     ...
     * @memberof ReportSubmit
     */
    public menuMode: ReportSubmitModel = new ReportSubmitModel();
...
<style lang='less'>
@import './report-submit-appmenu.less';
</style>