...
export default class Usr2MobTabExpViewtabexppanelBase extends Vue implements ControlInterface {
     ...
     *
     * @param {any} args
     * @memberof  Usr2MobTabExpViewtabexppanelBase
     */
     ...
     * 建构部件服务对象
     *
     * @type {Usr2MobTabExpViewtabexppanelService}
     * @memberof Usr2MobTabExpViewtabexppanel
     */
    protected service: Usr2MobTabExpViewtabexppanelService = new Usr2MobTabExpViewtabexppanelService({$store:this.$store});
...
<style lang='less'>
@import './usr2-mob-tab-exp-viewtabexppanel-tabexppanel.less';
</style>