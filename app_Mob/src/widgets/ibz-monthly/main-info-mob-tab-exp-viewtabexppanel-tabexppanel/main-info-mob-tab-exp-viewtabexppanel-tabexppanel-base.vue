...
export default class MainInfoMobTabExpViewtabexppanelBase extends Vue implements ControlInterface {
     ...
     *
     * @param {any} args
     * @memberof  MainInfoMobTabExpViewtabexppanelBase
     */
     ...
     * 建构部件服务对象
     *
     * @type {MainInfoMobTabExpViewtabexppanelService}
     * @memberof MainInfoMobTabExpViewtabexppanel
     */
    protected service: MainInfoMobTabExpViewtabexppanelService = new MainInfoMobTabExpViewtabexppanelService({$store:this.$store});
     ...
     * 销毁计数器服务
     *
     * @memberof IbzMonthlyMainInfoMobTabExpView
     */   
...
<style lang='less'>
@import './main-info-mob-tab-exp-viewtabexppanel-tabexppanel.less';
</style>